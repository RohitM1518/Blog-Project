...
function Home() {
    ...
    if (authStatus === false) {
        ...
        {/* <div className='flex w-full justify-center'>
            ...
            <section id="home" className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container mt-[-45px]">
        ...
        className="object-contain relative z-10" /> */}
          ...
          {shoes.map((image,index1)=>(
            <div key={index1}>
              <ShoeCard index={index1} imgURL={image} changeBigShoeImg={(shoe)=>setbigShoeImg(shoe)} 
